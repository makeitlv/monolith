...
class AdminAction
{
    ...
    {
        return $action
            ->add(Crud::PAGE_DETAIL, self::createResetPasswordAction())
    ...
    private static function createResetPasswordAction(): Action
    {
        return Action::new(self::RESET_PASSWORD, "Reset Password", "fa fa-passport")->linkToCrudAction(
            self::RESET_PASSWORD
        );
    }
}
